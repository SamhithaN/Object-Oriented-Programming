...
class teacher:public staff,protected edu
{
protected:
    char subj[20];
    char publication[20];
public:
    ...
    {
        cout<<"\nName:"<<name<<"\nCode:"<<code;
        cout<<"\nGeneral qualification:"<<gen_quali<<"\nProfessional Qualification:"<<prof_quali;
        cout<<"\nSubject:"<<subj<<"\nPublication:"<<publication;
    }

};

class officer:public staff,protected edu
{
protected:
    int grade;
public:
